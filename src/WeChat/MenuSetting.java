...
public class MenuSetting {
	...
	public static String appId = "wx651db78fe37301b5";
    public static String appSecret= "0f75cd5cafb4bc5aae20418036476625"; 
    ...
    public static void add() throws JSONException{
        ...
        String json = "{"
                ...
                + "\"type\":\"view\","
                + "\"name\":\"开始答题\","
                + "\"url\":\"http://vjxm84.natappfree.cc/weather/1.html\""
                + "}]"
        		+ "},"
        		+ "{"
        		+ "\"name\":\"我的排名\","
